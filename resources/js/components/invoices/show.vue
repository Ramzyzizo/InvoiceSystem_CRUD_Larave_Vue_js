...
const getInvoice = async () =>{
    let apiUrl = import.meta.env.VITE_APP_API_BASE_URL + 'show_invoice/'+props.id;
...
const deleteInvoice=(id)=>{
    let apiUrl = import.meta.env.VITE_APP_API_BASE_URL + 'delete_invoice/'+id;
    axios.get(apiUrl)
    router.push('/')
}
const home=()=>{
            ...
            <div>
                ...
                <div>
                    <ul  class="card__header-list">
                        ...
                        <li>
                            <!-- Select Btn Option -->
                            <button class="selectBtnFlat " @click="home()">
                                <i class=" fas fa-pencil-alt"></i>
                                Home
                            </button>
                            <!-- End Select Btn Option -->
