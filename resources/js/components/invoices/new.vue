<script setup>
    ...
    const indexForm = async ()=>{
        let apiUrl = import.meta.env.VITE_APP_API_BASE_URL + 'create_invoice';
    ...
    const onSave = ()=>{
        if(listCart.value.length>=1){
            ...
            let apiUrl = import.meta.env.VITE_APP_API_BASE_URL + 'add_invoice';
            ...
            <div>
                <div>
                    <ul  class="card__header-list">
                        <li>
                            <!-- Select Btn Option -->
                            <button class="selectBtnFlat btn btn-secondary" @click="home()">
